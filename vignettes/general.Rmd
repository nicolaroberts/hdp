...
lapply(chains(multi), plot_lik, bty="L")
lapply(chains(multi), plot_numcluster, bty="L")
lapply(chains(multi), plot_data_assigned, bty="L")
```
...
par(mfrow=c(2,2), mar=c(4, 4, 2, 1))
lapply(chains(hdp_p), plot_lik, bty="L")
lapply(chains(hdp_p), plot_numcluster, bty="L")
lapply(chains(hdp_p), plot_data_assigned, bty="L")
